...
<body>
    ...
    <p class="c-welcome">Welcome, ${sessionScope.username}!</p>
	...
	<div class="gioi_thieu">
		...
		<li class="phai">
			...
			<h1>Kinh nghiệm du lịch tự túc SaPa</h1> <span class="day">Posted
				on 02/09/2019 by <a href="#">Kha Ne </a>
		</span>
			<p class="text1">
				Share bài đi!!! Tôi vừa kết thúc chuyến du lịch Sapa tự túc
				...
				<br> Nói về Sapa, mình sẽ ví vẻ đẹp của Sapa với một cô gái
				vùng sơn cước. Cô gái ấy hồn nhiên, với đôi mắt xanh trong màu ngọc
				bích, đẹp như những dòng thác trong rừng sâu. Còn mái tóc nàng trải
				dài như dòng Mekong tới từ phương Bắc.<br>
				...
				những gì Việt Pha có thể nói với bạn về Sapa. <img
					src="img/kinhNghiemSP.jpg"><br>
				<span>Bình Minh ở SaPa</span>
			</p>
			<p class="text2">
			...
			<div class="text3">
				...
				<ul>
					<li><img
						...
						alt="">
						<p>
							<a href="cau_dat.jsp">Kinh nghiệm checkin Cầu đất</a>
						</p> <span>Th11,2,2018</span></li>
					<li><img
						src="img/kinhNghiemVH.jpg"
						alt="">
	...
	<div class="footer">
		<ul class="list_footer">
			...
			<li class="list2">
				...
				<p class="p5">HOTLINE 0132 456 789</p> <a
