...
<body>
	...
	<div class="gioi_thieu">
		...
		<li class="cau_dat">
			<ul>
				<li class="anh"><img class="anh_kinh_nghiem" width="50"
					height="50" src="img/kinhNghiemDL.jpg" alt="NhaTrang"></li>
		...
		<li class="phai">
			...
			<h1>Kinh nghiệm phượt Đà Lạt mùa Đông</h1> <span class="day">Posted
				on 02/09/2019 by <a href="#">Kha Ne </a>
		</span>
			<p class="text1">
				Share bài đi!!! Tôi vừa kết thúc chuyến du lịch Đà lạt tự túc
				...
				<br> Nói về Đà Lạt, mình sẽ ví vẻ đẹp của Đà Lạt với một cô gái
				...
				những gì Việt Pha có thể nói với bạn về Đà Lạt. <img
					src="img/kinhNghiemDL.jpg"><br> <span>Hoàng hôn ở
					Đà Lạt</span>
			</p>
			<p class="text2">
