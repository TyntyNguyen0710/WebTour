...
<body>
	...
	<div class="gioi_thieu">
		...
		<li class="phai">
			...
			<h1>Kinh nghiệm phượt Tây Bắc mùa Đông</h1> <span class="day">Posted
				on 02/11/2019 by <a href="#">Kha Ne </a>
		</span>
			<p class="text1">
				Share bài đi!!! Tôi vừa kết thúc chuyến du lịch Tây Bắc tự túc
				...
				Nói về Tây Bắc, mình sẽ ví vẻ đẹp của Tây Bắc với một cô gái vùng
				...
				thể nói với bạn về Đà Lạt. <img src="img/kinhNghiemTB.jpg"><br>
				<span>Lễ hội ẩm thực ở Tây Bắc</span>
			</p>
			<p class="text2">
