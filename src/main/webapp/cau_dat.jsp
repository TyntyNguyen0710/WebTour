...
<body>
		...
		<nav>
			<ul>
				...
				<li><c:if test="${not empty sessionScope.username}">
						<span class="c-welcome"><a href="information.jsp ">Chào
								mừng, ${sessionScope.username}!</a></span>
	...
	<div class="gioi_thieu">
							...
							<li class="tour_detail">
								<ul>
									...
									<li class="text"><a href="showTour.jsp?tourId=${tour.id}"
										class="ten_tour">${tour.name}</a><br> <span
										class="price1"><span
											style="text-decoration: line-through;">6.000.000VND</span></span><br>
										<span> class="price2"><fmt:setLocale value="vi_VN" />
											<fmt:formatNumber value="${tour.price}" /> VND
									</span><br></li>
								</ul>
							</li>
						</c:if>
		...
		<li class="cau_dat">
			<ul>
				<li class="anh"><img class="anh_kinh_nghiem" width="50"
					height="50" src="img/kinhNghiemCD.jpg" alt="NhaTrang"></li>
		...
		<li class="phai">
			...
			<h1>Kinh nghiệm checkin Cầu đất</h1> <span class="day">Posted
				on 02/09/2019 by <a href="#">Kha Ne </a>
		</span>
			<p class="text1">
				Share bài đi!!! Tôi vừa kết thúc chuyến du lịch Cầu đất tự túc
				trong 5 ngày, và giờ mình đang rất háo hức chia sẻ lại những kỷ niệm
				đẹp trong chuyến đi lang thang dọc vùng Bắc của mình.<br> <br>
				Nói về Cầu đất, mình sẽ ví vẻ đẹp của Cầu đất với một cô gái vùng
				sơn cước. Cô gái ấy hồn nhiên, với đôi mắt xanh trong màu ngọc bích,
				đẹp như những dòng thác trong rừng sâu. Còn mái tóc nàng trải dài
				như dòng Mekong tới từ phương Bắc.<br> <br> Nàng giấu kín
				nét đẹp của mình sau những rừng cây xanh bạt ngàn nên nàng vẫn còn
				là điều gì đấy bí ẩn, mới mẻ, lôi cuốn với những kẻ yêu thích khám
				phá. Hiền hòa, giản dị, lặng lẽ, yên bình là những gì Việt Pha có
				thể nói với bạn về Cầu đất. <img src="img/kinhNghiemCD.jpg"><br>
				<span>Đồi chè ở Cầu đất</span>
			</p>
			<p class="text2">
				...
				người nên ra bến xe nước ngầm đặt xe trước ngày đi.<br> <br>
				Với những bạn ở xa có thể gọi điện đặt trước qua hãng bus VIETTRANS
				– Hotline: 093 254 1114 – Xuất phát tại Hà Nội (có hai điểm đón là
				phố cổ Hà Nội và bến xe Nước Ngầm) đi qua cửa khẩu Nậm Cắn ( Nghệ
				An) và đến Luang Prabang.<br> <br> Giá vé: từ 900,000 –
				>1,000,000VND/chiều (tùy từng thời điểm)<br> <br> Lưu ý:
				nên đặt vé xe trước ngày đi 2-3 ngày tại bến xe Nước Ngầm (Hà Nội)<br>
				<br> <span>Đi Luang Prabang từ Hồ Chí Minh</span><br> <br>
				Nếu đi từ Hồ Chí Minh, các bạn có thể:<br> <br> (1) bay ra
				Hà Nội để đi xe khách sang Lào.<br> <br> Hoặc (2) đi xe
				khách lên Kon Tum (cửa khẩu Bờ Y) và bắt xe đi Pakse – Vientiane rồi
				đi tiếp qua Luang Prabang. Đi xe máy hoặc xe ô tô riêng qua Luang
				Prabang<br> <br> Mang xe qua Lào rất đơn giản, mình có anh
				bạn từng mang xe máy qua Lào, anh bạn chia sẻ lại “các bạn chỉ cần
				giấy tờ chính chủ và bằng lái xe quốc tế” là mang xe qua được. Ở cửa
				khẩu người ta không làm khó, chỉ cần đóng tiền lệ phí là cho qua.<br>
				...
				lái xe ô tô mình chưa tìm hiểu được.<br> <br> Các cửa khẩu
				Việt Lào bạn có thể đi:<br> Cửa khẩu Tây Trang (Điện Biên) –
				Cửa khẩu Loong Sập (Mộc Châu) – Cửa khẩu Bờ Y (Kon Tum) – Cửa khẩu
				Nậm Cắn (Nghệ An) – Cửa khẩu Cầu Treo (Hà Tĩnh) – Của khẩu Cha Leo
				(Quảng Bình) – Cửa khẩu Lao Bảo (Quảng Trị) – Cửa khẩu Na Mèo (Thanh
				Hóa)<br> <br> Lưu ý: Visa thường được chấp nhận ở tất cả
				cửa khẩu. Visa điện tử chỉ được chấp nhận ở 3 cửa khẩu: Nậm Cắn, Cầu
				Treo, Bờ Y bạn nhé!
			</p>
			<div class="text3">
				...
				<ul>
					...
					<li><img src="img/kinhNghiemVH.jpg" alt="">

						<p>
							<a href="vinh_hy.jsp">Kinh nghiệm du lịch Vĩnh Hy mùa Xuân</a>
						</p> <span>Th11,5,2019</span></li>
					<li><img src="img/kinhNghiemSP.jpg" alt="">

						<p>
							<a href="sapa.jsp">Kinh nghiệm checkin Sapa mùa Đông</a>
