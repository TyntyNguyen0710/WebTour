...
public class ChangePasswordServlet extends HttpServlet {
    ...
    private void sendConfirmationEmail(String username, String newPassword) {
        // Cài đặt thông tin của email
        String to = customerDAO.getIntance().selectEmailByUsername(username); // Thay thế bằng địa chỉ email của người dùng
        String subject = "Xác nhận thay đổi mật khẩu";
        String body = "Mật khẩu của tài khoản " + username + " đã được thay đổi thành công. Mật khẩu bạn vừa đổi là: " + newPassword;
